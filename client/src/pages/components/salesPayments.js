...
import ReuseSalesPayments from '../reusecomponents/reuseSalesPayments.js';
...
const SalesPayments = () => {
  ...
  useEffect(()=>{ 
      axios.get(`${API_BASE_URL}/salespayment`, {
          headers :{
  ...
  return (
    <div>
      {resdata.userType === "super Admin" && <ReuseSalesPayments value1={resdata} value2  = {signuphandle} value3 = {company_profile_dataa}/>}
      {resdata.userType === "admin" && <ReuseSalesPayments value1={resdata} value2  = {signuphandle} value3 = {company_profile_dataa}/>}
