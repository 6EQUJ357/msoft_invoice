...
import ReuseCategories from '../reusecomponents/reUseCategories.js'; 
...
const Categories = () => {
  ...
  return (
    <div>
      {resdata.userType === "super Admin" && <ReuseCategories value1={resdata} value2  = {signuphandle} value3 = {company_profile_dataa}/>}
